...
$lang = array_merge(
    $lang, array(
        ...
        'DOWNLOAD_PHPBB_HOME'   => 'phpBB is vrij in gebruik, zolang u kennis heeft genomen van de licentie waar de phpBB software onder valt. <a href="%s"Meer downloads.</a>'
    )
);